...
install_nagios(){
    ...
    wget --progress=bar:force https://assets.nagios.com/downloads/nagioscore/releases/nagios-4.3.1.tar.gz
...
install_nagios_plugins() {
    ...
    cd nagios-plugins/
    wget --progress=bar:force http://nagios-plugins.org/download/nagios-plugins-2.2.1.tar.gz
...
install_nrpe() {
    ...
    mkdir nrpe
    cd nrpe
    wget --progress=bar:force https://downloads.sourceforge.net/project/nagios/nrpe-3.x/nrpe-3.1.0.tar.gz
    tar zxf nrpe-*.tar.gz
    cd nrpe-*
