...
apache() {
    ...
    sudo apt update && sudo apt install apache2 apache2-utils libapache2-mod-php7.2 -y
}
# PHP Installation
php() {
    echo "Installing PHP"
...
<VirtualHost *:80>
    ServerAdmin admin@admlab.dev
    DocumentRoot /var/www/html/dokuwiki
    ServerName admlab.dev
    ServerAlias www.admlab.dev
...
restart() {
    ...
    sudo systemctl restart apache2
    echo "Web Installation: http://admlab.dev/install.php"
    exit
}
# Calling Functions
apache
